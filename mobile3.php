...
<head>
    ...
    <title>Google Pixel 9 Pro (Hazel, 256 GB, 16 GB RAM)</title>
</head>
<body>
    <header class="banner">
    ...
    <main>
        <div class="product-page">
            <div class="product-header">
                <h1>Google Pixel 9 Pro (Hazel, 256 GB, 16 GB RAM)</h1>
            </div>
            <div class="product-main">
                <div class="product-image">
                    <img src="pixel-9-pro.webp" alt="Google Pixel 9 Pro">
                ...
                <div class="product-details">
                    ...
                    <p>The Google Pixel 9 Pro in Hazel is a premium mobile device that offers advanced features and a sleek design. It comes with 256 GB of storage and 16 GB of RAM, providing ample space and performance for all your needs. The 5G capability ensures fast internet speeds and seamless connectivity.</p>
                    <h2>Key Features</h2>
                    <ul>
                    ...
                    <h2>Pricing</h2>
                    <p class="product-price">Starting from ₹3,999/m or ₹95,999</p>
                </div>
            </div>
        </div>
    </main>
