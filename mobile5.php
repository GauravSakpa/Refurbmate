...
<head>
    ...
    <title>Rog Phone 8 Pro (24GB of RAM and 1TB of inbuilt storage)</title>
</head>
<body>
    <header class="banner">
    ...
    <main>
        <div class="product-page">
            <div class="product-header">
                <h1>Rog Phone 8 Pro (24GB of RAM and 1TB of inbuilt storage)</h1>
            </div>
            <div class="product-main">
                <div class="product-image">
                    <img src="Rog phone 8.png" alt="Rog Phone 8 Pro">
                ...
                <div class="product-details">
                    ...
                    <p>The Rog Phone 8 Pro is a premium mobile device that offers advanced features and a sleek design. It comes with 1 TB of inbuilt storage and 24 GB of RAM, providing ample space and performance for all your needs. The 5G capability ensures fast internet speeds and seamless connectivity.</p>
                    <h2>Key Features</h2>
                    <ul>
                        <li>24 GB RAM</li>
                        <li>1 TB Inbuilt Storage</li>
                    ...
                    <h2>Pricing</h2>
                    <p class="product-price">Starting from ₹4,583/m or ₹1,09,999</p>
                </div>
            </div>
        </div>
    </main>
