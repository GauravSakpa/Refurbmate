...
<head>
    ...
    <title>Apple iPhone 16e (White, 128 GB)</title>
</head>
<body>
    <header class="banner">
    ...
    <main>
        <div class="product-page">
            <div class="product-header">
                <h1>Apple iPhone 16e (White, 128 GB)</h1>
            </div>
            <div class="product-main">
                <div class="product-image">
                    <img src="i phone 16e.webp" alt="Apple iPhone 16e">
                ...
                <div class="product-details">
                    ...
                    <p>The Apple iPhone 16e in White is a premium mobile device that offers advanced features and a sleek design. It comes with 128 GB of storage, providing ample space for all your needs. The 5G capability ensures fast internet speeds and seamless connectivity.</p>
                    <h2>Key Features</h2>
                    <ul>
                    ...
                    <h2>Pricing</h2>
                    <p class="product-price">Starting from ₹2,083/m or ₹49,999</p>
                </div>
            </div>
        </div>
    </main>
