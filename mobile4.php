...
<head>
    ...
    <title>OnePlus 13 | Smarter with OnePlus AI (12GB RAM, 256GB Storage Midnight Ocean)</title>
</head>
<body>
    <header class="banner">
    ...
    <main>
        <div class="product-page">
            <div class="product-header">
                <h1>OnePlus 13 | Smarter with OnePlus AI (12GB RAM, 256GB Storage Midnight Ocean)</h1>
            </div>
            <div class="product-main">
                ...
                <div class="product-details">
                    ...
                    <p>The OnePlus 13 in Midnight Ocean is a premium mobile device that offers advanced features and a sleek design. It comes with 256 GB of storage and 12 GB of RAM, providing ample space and performance for all your needs. The 5G capability ensures fast internet speeds and seamless connectivity.</p>
                    <h2>Key Features</h2>
                    <ul>
                        <li>256 GB Storage</li>
                        <li>12 GB RAM</li>
                        <li>5G Mobile Network</li>
                        <li>Midnight Ocean Color</li>
                        <li>Advanced Camera System</li>
                        <li>High-Resolution Display</li>
                        <li>Long-Lasting Battery Life</li>
                    </ul>
                    <h2>Pricing</h2>
                    <p class="product-price">Starting from ₹2,499/m or ₹59,999</p>
                </div>
            </div>
        </div>
    </main>
